...
from schema.post_tag_schema import FindPost, FindPostWithTagsResult, PostWithTags, UpsertPostWithTags
...
@inject
def get_post_list(find_query: FindPost = Depends(),
...
@inject
def create_post(post: UpsertPostWithTags,
                service: PostService = Depends(Provide[Container.post_service]),
